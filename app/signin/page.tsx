            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#3B5998] focus:border-[#3B5998] outline-none transition-all text-slate-800 placeholder:text-slate-400"
              ...
              <div className="space-y-2">
                {DEMO_USERS.map((user) => (
                  <button
                    ...
                    className="w-full flex items-center justify-between text-sm bg-slate-50 hover:bg-slate-100 px-4 py-2.5 rounded-lg transition-colors group"
                  >
                    <span className="text-slate-600 font-medium">{user.name}</span>
                    <code className="text-[#3B5998] font-mono text-xs bg-white px-2 py-1 rounded border border-slate-200 group-hover:border-[#3B5998]/30">
