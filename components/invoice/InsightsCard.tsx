...
const SEVERITY_STYLE: Record<InsightSeverity, { border: string; bg: string; title: string; badge: string }> = {
  danger: { border: "border-l-red-400", bg: "bg-danger-bg/60", title: "text-danger", badge: "Warning" },
  warning: { border: "border-l-amber-400", bg: "bg-warning-bg/60", title: "text-warning", badge: "Recommendation" },
  info: { border: "border-l-blue-400", bg: "bg-info-bg/60", title: "text-info", badge: "Information" },
  success: { border: "border-l-emerald-400", bg: "bg-success-bg/60", title: "text-success", badge: "Success" },
};
            ...
            >
              ...
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className={`rounded-full bg-surface/70 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide ${style.title}`}>
                    {style.badge}
                  </span>
                </div>
